...
// Backs the collapsible "due soon" rollup. It's a non-critical view, so a failed fetch just
// yields an empty list (the section collapses) rather than surfacing an error.
